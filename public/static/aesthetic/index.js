...
function findTypeTime (textToType, textSpeed) {
  return textSpeed * textToType.length * 3 * 1.75;
}
...
setTimeout(async function () {
  ...
  setTimeout(async function () {
    let commandOutput = "WHAT_ARE_YOUR_COMMANDS?";
    await actualType("WHAT_ARE_YOUR_COMMANDS?", samaritanInterface, 40);
    setTimeout(function () {
      $("#sammy").fadeIn(2000);
    }, findTypeTime(commandOutput, 40));
  }, 1000);
}, 2000);